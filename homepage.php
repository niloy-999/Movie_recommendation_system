...
<head>
  <meta charset="utf-8">
  <title>NiloyFlix-Homepage</title>
  ...
  <body>
    <header>
            ...
            <ul class="navbar-nav">
              ...
              if (isset($_SESSION['id'])) {
                if ($_SESSION['id'] == 1) {
                  ...
                  echo "<li class='nav-item'> <a href='edit_movie.php' class='nav-link'>Edit movie</a> </li>";
                  echo "<li class='nav-item'> <a href='delete_movie.php' class='nav-link'>Delete movie</a> </li>";
                }
              }
              ...
              echo"<h1 style='color:skyblue;position:sticky;'>WELCOME </h1><b style = 'color: yellow;font-size: 25px'><i> ".ucwords($rel['name'])." !</i></b>
                  </div>
                  </header>
                  <section>
      ...
      <div class="jumbotron">
        <h2 style='margin-top:0px;padding-top:0px;'>Recommendation</h2>
          <div class="row">
            <?php
